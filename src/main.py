...
def real_data(pickle_fname="terrain_data_default.pickle"):
    """Part d)-e)."""
...
def franke_func_tasks(pickle_fname="franke_data_default.pickle"):
    """Part a)-c)."""
    ...
    # polynom_degrees = [1,3,5]
    # alpha_values = [1e-3, 1e-1, 1]
